...
blocks.fill(GLASS, pos(7, -3, 7), pos(-7, -3, -7), FillOperation.REPLACE)
blocks.fill(WATER, pos(6, -2, 6), pos(-6, -2, -6), FillOperation.REPLACE)
blocks.fill(GLASS, pos(4, -1, 4), pos(-4, -1, -4), FillOperation.REPLACE)
blocks.place(SOUL_SAND, pos(-6, -3,  6))

for index in range(100):
    mobs.spawn(TROPICAL_FISH, pos(6, 1, 6))
for index in range(10):
    mobs.spawn(SEA_TURTLE, pos(0, -2, 0))
