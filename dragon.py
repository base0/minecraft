...
shapes.line(RED_CONCRETE, offset(0, 0, 0), offset(0, 108, 0))
...
y -= dy
d = radius + 2
blocks.fill(LIME_GLAZED_TERRACOTTA, offset(x - radius, y - d, z), offset(x + radius, y + d, z + radius * 2))


# mouth
blocks.fill(YELLOW_GLAZED_TERRACOTTA, offset(x - radius, y - d, z + radius * 2), offset(x + radius, y, z + radius * 5))
